...
{% openapi-operation spec="stork-rest-from-endpoint" path="/v1/prices/assets" method="get" %}
[OpenAPI stork-rest-from-endpoint](https://rest.jp.stork-oracle.network/openapi.yaml)
{% endopenapi-operation %}

{% openapi-operation spec="stork-rest-from-endpoint" path="/v1/prices/latest" method="get" %}
[OpenAPI stork-rest-from-endpoint](https://rest.jp.stork-oracle.network/openapi.yaml)
{% endopenapi-operation %}

{% openapi-operation spec="stork-rest-from-endpoint" path="/v1/prices/recent" method="get" %}
[OpenAPI stork-rest-from-endpoint](https://rest.jp.stork-oracle.network/openapi.yaml)
{% endopenapi-operation %}

{% openapi-operation spec="stork-rest-from-endpoint" path="/v1/tradingview/history" method="get" %}
[OpenAPI stork-rest-from-endpoint](https://rest.jp.stork-oracle.network/openapi.yaml)
{% endopenapi-operation %}

{% openapi-operation spec="stork-rest-from-endpoint" path="/v1/market_status" method="get" %}
[OpenAPI stork-rest-from-endpoint](https://rest.jp.stork-oracle.network/openapi.yaml)
{% endopenapi-operation %}

{% openapi-operation spec="stork-rest-from-endpoint" path="/v1/deployments/evm" method="get" %}
[OpenAPI stork-rest-from-endpoint](https://rest.jp.stork-oracle.network/openapi.yaml)
{% endopenapi-operation %}

{% openapi-operation spec="stork-rest-from-endpoint" path="/v0/deployments/stork_pushed_assets" method="get" %}
[OpenAPI stork-rest-from-endpoint](https://rest.jp.stork-oracle.network/openapi.yaml)
{% endopenapi-operation %}
